...
const WhatsAppChat: React.FC<WhatsAppChatProps> = ({
  ...
  return (
    <a
      ...
      className="flex cursor-pointer items-center gap-2.5 px-3 py-2 text-white bg-gradient-to-tr from-green-400 to-green-600 rounded-md transition hover:opacity-90"
    >
