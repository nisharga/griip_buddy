...
export default function LoadingHeroSkeleton() {
  return (
    <div className="w-full flex flex-col lg:flex-row h-auto md:max-h-107.5 gap-0.5 sm:gap-4 md:gap-5 sm:max-container">
      {/* Desktop categories skeleton */}
      <div className="w-full hidden lg:flex flex-col shrink-0 max-w-85 h-auto rounded-t-xl overflow-hidden drop-shadow-[1px_1px_4px_0px_#0000001A]">
            ...
            .map((_, i) => (
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-12.5 h-12.5 rounded-md bg-gray-200 relative overflow-hidden">
                    <div className="absolute inset-0 -translate-x-full animate-[shimmer_1.5s_infinite] bg-linear-to-r from-gray-200 via-white to-gray-200"></div>
                  </div>
      ...
      <div className="grow sm:rounded lg:rounded-xl overflow-hidden h-fit order-1 lg:order-2">
        <div className="h-fit md:h-full w-full relative overflow-hidden">
          ...
          <div className="hidden sm:block w-full lg:max-h-107.5 h-75 md:h-107.5 bg-gray-200 relative overflow-hidden">
            <div className="absolute inset-0 -translate-x-full animate-[shimmer_1.5s_infinite] bg-linear-to-r from-gray-200 via-white to-gray-200"></div>
          </div>

          {/* Mobile banner skeleton */}
          <div className="block sm:hidden w-full h-37.5 bg-gray-200 relative overflow-hidden">
            <div className="absolute inset-0 -translate-x-full animate-[shimmer_1.5s_infinite] bg-linear-to-r from-gray-200 via-white to-gray-200"></div>
          </div>
      ...
      <div className="order-2 lg:hidden w-full px-2 sm:px-0 mt-4">
        ...
        <div className="w-full overflow-scroll flex items-center gap-1.5 no-scrollbar mt-2 pb-2">
          {Array(8)
            ...
            .map((_, i) => (
              <div
                className="flex flex-col items-center gap-1 min-w-15 p-2 bg-white rounded-lg"
                key={i}
              >
                <div className="w-7.5 h-7.5 rounded-full bg-gray-200 relative overflow-hidden">
                  <div className="absolute inset-0 -translate-x-full animate-[shimmer_1.5s_infinite] bg-linear-to-r from-gray-200 via-white to-gray-200"></div>
                </div>
