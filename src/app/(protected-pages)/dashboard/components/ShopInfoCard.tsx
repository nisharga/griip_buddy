        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="font-semibold text-lg text-secondary">
              {shop?.name || "Shop Name Not Set"}
            </h3>
            <p className="text-sm text-muted-foreground">
              Slug: {shop?.slug || "Not generated"}
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">
              {shop?.phone_number || "Phone not provided"}
            </span>
          </div>
              ...
              {shop?.address?.coordinates?.lat &&
                shop?.address?.coordinates?.lng && (
                  <p className="text-muted-foreground text-xs mt-1">
                    Coordinates: {shop.address.coordinates.lat},{" "}
                    {shop.address.coordinates.lng}
                  </p>
                )}
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm">
              {shop?.slug ? `/${shop.slug}` : "Shop URL not available"}
            </span>
          </div>
        </div>
      </CardContent>
