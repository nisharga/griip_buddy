...
import { useLoginMutation } from "@/src/redux/api/old/auth-api";
              ...
              <form onSubmit={handleSubmit} className="space-y-3 lg:space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 text-sm py-3 border  rounded-lg placeholder:text-gray-400 focus:outline-none focus:ring-2 transition-colors ${
                      errors.phoneNumber
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 text-sm border placeholder:text-gray-400 rounded-lg focus:outline-none focus:ring-2 transition-colors pr-10 ${
                        errors.password
                          ? "border-red-500 focus:ring-red-500"
